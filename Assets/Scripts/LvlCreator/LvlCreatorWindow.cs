...
public class LvlCreatorWindow : EditorWindow
{
    ...
    public static void ShowWindow()
    {
      ...
      private void OnGUI()
      {
        ...
        if (GUILayout.Button("Isom�trica", GUILayout.Height(30)))
        {
        ...
        {
            EditorGUILayout.HelpBox("Asign� un Prefab Database", MessageType.Warning);
        ...
        foreach (var obj in placedObjects)
        {
            if (obj != null)
            {
                ...
                {
                    objectToRemove = obj; // Marcar para eliminar despu�s
                }
                EditorGUILayout.EndHorizontal();
            }
        }
    ...
    private void SwitchToCamera(string cameraName)
    {
        ...
        if (vcam == null)
        {
            Debug.LogWarning("No se encontr� la c�mara: " + cameraName);
            return;
        }
